...
export function Home(): ReactElement {
  ...
  const [activeProviderApiDetails, setActiveProviderApiDetails] = useState<ServiceProviderAPIVersionDetails | undefined>(undefined);
  ...
  return (
    <>
      ...
      {displayProviderApiDetails && activeProviderApiDetails && <ServiceProviderApiDetails providerApiDetails={activeProviderApiDetails} onClickExploreMore={onClickExploreMore}/>}
    </>
  )
}
